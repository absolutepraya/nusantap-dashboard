...
import {
	...
	IconQrcode,
	IconMenu2, // Importing the hamburger icon
	IconX, // Importing the close icon
...
export default function Sidebar({ location }: SidebarProps) {
	...
	return (
		<>
			...
			<button
				className="z-[100] fixed left-4 top-4 flex items-center justify-center rounded-md bg-white p-2 text-custgray1 shadow-md md:hidden"
			...
			<div>
				{/* Desktop Sidebar */}
				<div className="fixed z-50 hidden h-full w-60 flex-col justify-between border border-r border-gray-300 bg-first pt-4 shadow md:flex">
						...
						{changeProfileDialog && (
							<div className="absolute bottom-[5.5rem] left-4 flex w-64 flex-col space-y-2 rounded-lg border bg-second px-4 py-3 shadow">
								...
								<div className="flex h-8 w-full flex-row space-x-2">
									<div className="flex h-full w-1/2 cursor-not-allowed items-center justify-center rounded-lg bg-custblue text-white">
										<p>Tambah Profil</p>
									</div>
									<div className="flex h-full w-1/2 cursor-not-allowed items-center justify-center rounded-lg bg-custblue text-white">
										<p>Edit Profil</p>
				...
				{/* Mobile Sidebar */}
				<div className={`fixed left-0 top-0 z-50 h-full w-60 transform bg-first shadow transition-transform duration-300 ease-in-out ${isMobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col justify-between md:hidden`}>
					{/* Close button */}
					<div className="flex justify-end p-4">
						<button
							onClick={closeMobileSidebar}
							className="text-custgray1"
